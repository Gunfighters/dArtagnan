...
namespace Assets.HeroEditor4D.InventorySystem.Scripts.Data
{
    ...
    public class ItemParams
    {
...
#endif
        public List<LocalizedValue> Localization = new();
        ...
        {
            var localized = Localization.SingleOrDefault(i => i.Language == language) ??
                            Localization.SingleOrDefault(i => i.Language == "English");
