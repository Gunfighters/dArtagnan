...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
    ...
    public class Character4D : MonoBehaviour
    {
        ...
        {
            set { Parts.ForEach(i => i.Body = value.ToList()); }
        }

        public List<Sprite> Head
        {
            set { Parts.ForEach(i => i.Head = i.HairRenderer.GetComponent<SpriteMapping>().FindSprite(value)); }
        }

        public List<Sprite> Hair
        {
            set { Parts.ForEach(i => i.Hair = i.HairRenderer.GetComponent<SpriteMapping>().FindSprite(value)); }
        }
        ...
        public List<Sprite> Beard
        {
            set
            {
                Parts.ForEach(i =>
                {
                    if (i.BeardRenderer) i.Beard = i.BeardRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        ...
        {
            set { Parts.ForEach(i => i.Ears = value.ToList()); }
        }
        ...
        public List<Sprite> Eyebrows
        {
            set
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Eyebrows = i.EyebrowsRenderer.GetComponent<SpriteMapping>().FindSprite(value));
            }
        }
        ...
        public List<Sprite> Eyes
        {
            ...
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Eyes = i.EyesRenderer.GetComponent<SpriteMapping>().FindSprite(value));
            }
        }
        ...
        public List<Sprite> Mouth
        {
            ...
            {
                PartsExceptBack.ForEach(i =>
                    i.Expressions[0].Mouth = i.MouthRenderer.GetComponent<SpriteMapping>().FindSprite(value));
            }
        }

        public List<Sprite> Helmet
        {
        ...
        {
            set { Parts.ForEach(i => i.PrimaryWeapon = value); }
        }

        public Sprite SecondaryWeapon
        {
            set { Parts.ForEach(i => i.SecondaryWeapon = value); }
        }

        public List<Sprite> Shield
        {
            set { Parts.ForEach(i => i.Shield = value.ToList()); }
        }

        public List<Sprite> CompositeWeapon
        {
            set { Parts.ForEach(i => i.CompositeWeapon = value.ToList()); }
        }

        public List<Sprite> Makeup
        {
            set
            {
                Parts.ForEach(i =>
                {
                    if (i.MakeupRenderer) i.Makeup = i.MakeupRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        ...
        public List<Sprite> Mask
        {
            set
            {
                Parts.ForEach(i =>
                {
                    if (i.MaskRenderer) i.Mask = i.MaskRenderer.GetComponent<SpriteMapping>().FindSprite(value);
                });
            }
        }
        ...
        {
            set { Parts.ForEach(i => i.Earrings = value.ToList()); }
        }

        public WeaponType WeaponType
        {
            get => Front.WeaponType;
            set { Parts.ForEach(i => i.WeaponType = value); }
        }
        ...
        {
            Equip(SpriteCollection.MeleeWeapon1H.SingleOrDefault(i => i.Id == item.Params.SpriteId),
                EquipmentPart.MeleeWeapon1H);
        }

        public void EquipMeleeWeapon2H(Item item)
        {
            Equip(SpriteCollection.MeleeWeapon2H.SingleOrDefault(i => i.Id == item.Params.SpriteId),
        ...
        {
            Equip(SpriteCollection.Firearm1H.SingleOrDefault(i => i.Id == item.Params.SpriteId),
