...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
    public class AvatarSetup : MonoBehaviour
    {
        ...
        public void Initialize(CharacterAppearance appearance, string helmetId)
        {
            ...
            Head.sprite = SpriteCollections.SelectMany(i => i.Body).Single(i => i.Id == appearance.Body).Sprites
                .Single(i => i.name == "FrontHead");
            ...
            Beard.sprite = appearance.Beard.IsEmpty()
                ? null
                : SpriteCollections.SelectMany(i => i.Beard).Single(i => i.Id == appearance.Beard).Sprite;
            ...
            else
            {
                ...
                Eyebrows.sprite = SpriteCollections.SelectMany(i => i.Eyebrows).Single(i => i.Id == appearance.Eyebrows)
                    .Sprite;
            }
            ...
            else
            {
                ...
                if (!fullHair)
                {
                    Hair.sprite = SpriteCollections.SelectMany(i => i.Hair)
                        .SingleOrDefault(i => i.Id == "Common.Basic.Hair.Default")?.Sprites[1];
