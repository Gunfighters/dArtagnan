...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
    ...
    public partial class Character : MonoBehaviour
    {
        ...
        [Header("Body")] public List<Sprite> Ears;
        ...
        [Header("Expressions")] public string Expression = "Default";

        public List<Expression> Expressions;

        [Header("Equipment")] public Sprite Helmet;
        ...
        [Header("Accessories")] public Sprite Makeup;

        public Sprite Mask;
        public List<Sprite> Earrings;

        [Header("Body renderers")] public List<SpriteRenderer> BodyRenderers;
        ...
        [Header("Equipment renderers")] public SpriteRenderer HelmetRenderer;
        ...
        [Header("Accessories renderers")] public SpriteRenderer MakeupRenderer;
        ...
        [Header("Animation")] public WeaponType WeaponType;

        [Header("Meta")] public bool HideEars;

        public bool CropHair;

        [Header("Anchors")] public Transform AnchorBody;

        public Transform AnchorSword;
        public Transform AnchorBow;
        public Transform AnchorFireMuzzle;

        [Header("Service")] public LayerManager LayerManager;

        [Header("Custom")] public List<Sprite> Underwear;
        ...
        private void TryInitialize()
        {
            ...
            if (!expressionNames.Contains("Default") || !expressionNames.Contains("Angry") ||
                !expressionNames.Contains("Dead"))
        ...
        private void MapSprite(SpriteRenderer spriteRenderer, List<Sprite> sprites)
        {
            SetSprite(spriteRenderer,
                sprites == null ? null : spriteRenderer.GetComponent<SpriteMapping>().FindSprite(sprites));
        }
        ...
        private void ApplyMaterials()
        {
            ...
            renderers.ForEach(i =>
                i.sharedMaterial = i.color == Color.white ? DefaultMaterial : EquipmentPaintMaterial);
        }

        public void CopyFrom(Character character)
        {
            if (character == null)
                throw new ArgumentNullException(nameof(character), "Can't copy from empty character!");
