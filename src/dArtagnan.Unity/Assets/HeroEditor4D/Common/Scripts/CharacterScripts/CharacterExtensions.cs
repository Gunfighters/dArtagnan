...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
    ...
    {
        public static Color RandomColor => new(Random.Range(0, 1f), Random.Range(0, 1f), Random.Range(0, 1f), 1f);
        ...
        public static void Randomize(this Character4D character)
        {
            ...
            if (character.Front.SpriteCollection.Eyes.Count > 0)
                character.SetBody(character.Front.SpriteCollection.Eyes.Random(), BodyPart.Eyes, RandomColor);
            ...
            {
                case 0:
                    character.Equip(character.Front.SpriteCollection.MeleeWeapon1H.Random(),
                ...
                case 1:
                    ...
                    break;
                case 2:
                    character.Equip(character.Front.SpriteCollection.MeleeWeapon2H.Random(),
                ...
                case 3:
                    ...
                    break;
                case 4:
                    character.Equip(character.Front.SpriteCollection.Firearm1H.Random(),
