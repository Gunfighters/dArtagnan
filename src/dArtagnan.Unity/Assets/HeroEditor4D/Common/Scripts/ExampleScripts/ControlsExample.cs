...
namespace Assets.HeroEditor4D.Common.Scripts.ExampleScripts
{
    ...
    public class ControlsExample : MonoBehaviour
    {
            ...
            if (Input.GetKeyDown(KeyCode.S))
            {
                switch (Character.WeaponType)
                {
                    case WeaponType.Melee1H:
                        Character.AnimationManager.Slash(false);
                        break;
                    case WeaponType.Melee2H:
                    case WeaponType.Paired:
                        Character.AnimationManager.Slash(true);
                        break;
                    case WeaponType.Bow:
            ...
            else if (Input.GetKey(KeyCode.F))
            {
                ...
                switch (Character.WeaponType)
                {
                    ...
                    case WeaponType.Firearm2H:
                    {
                        ...
                        {
                            var firearm = Character.SpriteCollection.Firearm1H.SingleOrDefault(i =>
                                              i.Sprites.Contains(Character.Parts[0].PrimaryWeapon))
                                          ?? Character.SpriteCollection.Firearm2H.SingleOrDefault(i =>
                                              i.Sprites.Contains(Character.Parts[0].PrimaryWeapon));
        ...
        {
            if (Input.GetKeyDown(KeyCode.I)) Character.AnimationManager.SetState(CharacterState.Idle);

            if (Input.GetKeyDown(KeyCode.E)) Character.AnimationManager.SetState(CharacterState.Ready);

            if (Input.GetKeyDown(KeyCode.W)) Character.AnimationManager.SetState(CharacterState.Walk);

            if (Input.GetKeyDown(KeyCode.R)) Character.AnimationManager.SetState(CharacterState.Run);

            if (Input.GetKeyDown(KeyCode.U)) Character.AnimationManager.SetState(CharacterState.Jump);

            if (Input.GetKeyDown(KeyCode.C)) Character.AnimationManager.SetState(CharacterState.Climb);

            if (Input.GetKeyDown(KeyCode.D)) Character.AnimationManager.Die();

            if (Input.GetKeyDown(KeyCode.H)) Character.AnimationManager.Hit();

            if (Input.GetKeyDown(KeyCode.B))
                Character.AnimationManager.SetState(CharacterState.ShieldBlock);
            else if (Input.GetKeyUp(KeyCode.B)) Character.AnimationManager.SetState(CharacterState.Idle);
        }
