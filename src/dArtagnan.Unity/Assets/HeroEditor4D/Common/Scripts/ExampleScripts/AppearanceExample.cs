...
namespace Assets.HeroEditor4D.Common.Scripts.ExampleScripts
{
    ...
    public class AppearanceExample : MonoBehaviour
    {
        ...
        public void Refresh()
        {
            ...
            var helmetId = Character.SpriteCollection.Armor
                .SingleOrDefault(i => i.Sprites.Contains(Character.Front.Helmet))?.Id;
        ...
        {
            Appearance.Hair = Random.Range(0, 3) == 0
                ? null
                : Character.SpriteCollection.Hair[Random.Range(0, Character.SpriteCollection.Hair.Count)].Id;
            Appearance.HairColor = new Color(Random.Range(0, 1f), Random.Range(0, 1f), Random.Range(0, 1f));
            Appearance.Eyebrows = Character.SpriteCollection
                .Eyebrows[Random.Range(0, Character.SpriteCollection.Eyebrows.Count)].Id;
            Appearance.Eyes = Character.SpriteCollection.Eyes[Random.Range(0, Character.SpriteCollection.Eyes.Count)]
                .Id;
            Appearance.EyesColor = new Color(Random.Range(0, 1f), Random.Range(0, 1f), Random.Range(0, 1f));
            Appearance.Mouth = Character.SpriteCollection.Mouth[Random.Range(0, Character.SpriteCollection.Mouth.Count)]
                .Id;
            Appearance.Beard = Random.Range(0, 3) == 0
                ? Character.SpriteCollection.Beard[Random.Range(0, Character.SpriteCollection.Beard.Count)].Id
                : null;
