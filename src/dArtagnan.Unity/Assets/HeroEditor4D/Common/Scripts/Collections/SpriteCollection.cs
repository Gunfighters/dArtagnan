...
namespace Assets.HeroEditor4D.Common.Scripts.Collections
{
    ...
    public class SpriteCollection : ScriptableObject
    {
        ...
        [Header("Where to find sprites?")] public List<Object> SpriteFolders;
        ...
        [Header("Service")] public bool IncludePsd;
        ...
        public List<ItemSprite> GetAllSprites()
        {
            return Body.Union(Ears).Union(Hair).Union(Beard).Union(Eyebrows).Union(Eyes).Union(Mouth)
                ...
                .Union(Bow).Union(Crossbow).Union(Firearm1H).Union(Firearm2H).Union(Shield).Union(Throwable)
                .Union(Supplies)
